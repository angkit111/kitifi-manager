...
<table id="tFilter" class="table table-bordered table-hover text-nowrap">
  ...
  <tr> 
	...
	?></th>
		...
		<th class="align-middle">Random<br>Mac Sync</th>
		<th class="align-middle"><?= $_expired_mode ?></th>
		<th class="align-middle"><?= $_lock_user ?></th>
		<th class="align-middle">Telegram<br>Sales Report</th>
		<th class="align-middle" >Record Sales</th>
		<th class="text-right align-middle" >Total Sales</th>
    </tr>
  </thead>
  <tbody>
<?php
