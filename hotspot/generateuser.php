...
date_default_timezone_set($_SESSION['timezone']);
	...
	if (isset($_POST['qty'])) {
		...
		$commt = $validity . "m,".$price.",0,". $sesname;
		$gentemp = $commt . "|~" . $profile . "~" . $getvalid . "~" . $price . "!".$getsprice."~" . $timelimit . "~" . $validity . "~" . $getlock;
  ...
  <tr>
    ...
    <td class="align-middle"><?= $_user_mode ?></td><td>
			<select class="form-control " id="user" name="user" required="1">
				<option value="up"><?= $_user_only ?></option>
  ...
  <tr>
    <td class="align-middle"><?= $_character ?></td><td>
      <select class="form-control " name="char" required="1">
				<option id="lower" style="display:none;" value="lower"><?= $_random ?> abcd</option>
				<option id="upper" style="display:none;" value="upper"><?= $_random ?> ABCD</option>
				<option id="upplow" style="display:none;" value="upplow"><?= $_random ?> aBcD</option>
				<option id="lower1" style="display:block;" value="lower"><?= $_random ?> abcd2345</option>
				<option id="upper1" style="display:block;" value="upper"><?= $_random ?> ABCD2345</option>
				<option id="upplow1" style="display:block;" value="upplow"><?= $_random ?> aBcD2345</option>
				...
				<option id="num" style="display:block;" value="num"><?= $_random ?> 1234</option>
			</select>
    </td>
  </tr>
  <tr>
	...
	<tr>
	<td class="align-middle"><?= $_validity ?></td><td><input class="form-control " type="text" size="4" autocomplete="off" name="validity" value=""></td>
	...
	<tr>
	<td class="align-middle"><?= $_price ?></td><td><input class="form-control " type="text" size="4" autocomplete="off" name="price" value=""></td>
  </tr>
	<!--<tr>
