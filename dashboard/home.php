      ...
      <div class="box bmh-75 box-bordered">
        ...
        <div class="row">
          ...
          <div  class="col-4">
            <div id="r_2"class="row">
            <div class="card">
              <div class="card-header"><h3><i class="fa fa-money"></i> Sales Report</h3></div>
                <div class="card-body">
                  <div class="row">
                  <div class="col-6 col-box-6">
                    <div class="box bg-red bmh-75">
                      <a>
                        <div>
                          <h1> <?php echo "<span style='font-size: 25px;'>". $currency ." ". number_format($dailySales['source'])."</span>" ?> </h1>
                        </div>
                        <div>
                             <i class="fa fa-money"></i> <?php echo $_today ?>
                        </div>
                    </a>
                  </div>
                </div>
                  <div class="col-6 col-box-6">
                    <div class="box bg-red bmh-75">
                      <a>
                        <div>
                          <h1> <?php echo "<span style='font-size: 25px;'>". $currency ." ". number_format($monthlySales['source'])."</span>" ?> </h1>
                        </div>
                        <div>
                             <i class="fa fa-money"></i> <?php echo $_this_month ?>
                        </div>
                    </a>
                  </div>
                </div>
